...
function getSecret() {
  ...
  if (!fallbackSecret) {
    ...
    console.warn(
      "[WARNING] SESSION_SECRET is missing or shorter than 16 characters. Using a generated temporary secret. Set SESSION_SECRET in your environment variables for persistent sessions."
    );
  }
